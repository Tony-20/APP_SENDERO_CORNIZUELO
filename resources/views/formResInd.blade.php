...
<html lang="es">
<head>
	<title>Reservación de Caminata Individual</title>
	<meta charset="UTF-8">
		...
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-form-title" style="background-image: url(images/corni.jpg);">
                    ...
                    Reservación de Caminata Individual
					</span>
				</div>
                ...
                <form action="" method="post" >
                    ...
                    <div class="form-row">
						<div class="form-group col-md-6">
						<label for="inputVisita">Tipo de visita</label>
						<select id="inputTipo" class="form-control">
							<option selected>Elija...</option>
                            <option value="ln">Recreación</option>
							<option value="in">Investigación</option>
                            <option value="re">Docencia</option>
                            <option value="in">Limpieza</option>
                            <option value="re">Educación Ambiental</option>
						</select>
						</div>
					</div>                    
